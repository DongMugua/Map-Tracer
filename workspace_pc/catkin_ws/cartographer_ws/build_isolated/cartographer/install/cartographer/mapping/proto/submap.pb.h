...
class Submap2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Submap2D) */ {
 public:
  ...
  const ::cartographer::mapping::proto::ProbabilityGrid& probability_grid() const;
  ::cartographer::mapping::proto::ProbabilityGrid* mutable_probability_grid();
  ::cartographer::mapping::proto::ProbabilityGrid* release_probability_grid();
  void set_allocated_probability_grid(::cartographer::mapping::proto::ProbabilityGrid* probability_grid);
 ...
 private:
  ...
  ::cartographer::mapping::proto::ProbabilityGrid* probability_grid_;
...
inline const ::cartographer::mapping::proto::ProbabilityGrid& Submap2D::probability_grid() const {
...
inline ::cartographer::mapping::proto::ProbabilityGrid* Submap2D::mutable_probability_grid() {
...
inline ::cartographer::mapping::proto::ProbabilityGrid* Submap2D::release_probability_grid() {
...
inline void Submap2D::set_allocated_probability_grid(::cartographer::mapping::proto::ProbabilityGrid* probability_grid) {
