...
class PoseGraph_LandmarkDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<PoseGraph_Landmark>
     _instance;
} _PoseGraph_Landmark_default_instance_;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PoseGraph_Landmark, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PoseGraph_Landmark, landmark_id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PoseGraph_Landmark, global_pose_),
  ~0u,  // no _has_bits_
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PoseGraph, landmarks_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(SubmapId)},
  { 7, -1, sizeof(NodeId)},
  { 14, -1, sizeof(PoseGraph_Constraint)},
  { 25, -1, sizeof(PoseGraph_Landmark)},
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&_PoseGraph_Landmark_default_instance_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PoseGraph_Constraint_default_instance_);_PoseGraph_Landmark_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PoseGraph_Landmark_default_instance_);_PoseGraph_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
  ...
  _PoseGraph_Landmark_default_instance_._instance.get_mutable()->global_pose_ = const_cast< ::cartographer::transform::proto::Rigid3d*>(
      ::cartographer::transform::proto::Rigid3d::internal_default_instance());
}
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "ctory_id\030\001 \001(\005\022\022\n\nnode_index\030\002 \001(\005\"\213\005\n\tP"
      ...
      "g.proto.Trajectory\022A\n\tlandmarks\030\005 \003(\0132.."
      "cartographer.mapping.proto.PoseGraph.Lan"
      "dmark\032\333\002\n\nConstraint\0227\n\tsubmap_id\030\001 \001(\0132"
      "$.cartographer.mapping.proto.SubmapId\0223\n"
      "\007node_id\030\002 \001(\0132\".cartographer.mapping.pr"
      "oto.NodeId\022<\n\rrelative_pose\030\003 \001(\0132%.cart"
      "ographer.transform.proto.Rigid3d\022\032\n\022tran"
      "slation_weight\030\006 \001(\001\022\027\n\017rotation_weight\030"
      "\007 \001(\001\022A\n\003tag\030\005 \001(\01624.cartographer.mappin"
      "g.proto.PoseGraph.Constraint.Tag\")\n\003Tag\022"
      "\020\n\014INTRA_SUBMAP\020\000\022\020\n\014INTER_SUBMAP\020\001\032[\n\010L"
      "andmark\022\023\n\013landmark_id\030\001 \001(\t\022:\n\013global_p"
      "ose\030\002 \001(\0132%.cartographer.transform.proto"
      ".Rigid3db\006proto3"
  };
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int PoseGraph_Landmark::kLandmarkIdFieldNumber;
const int PoseGraph_Landmark::kGlobalPoseFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

PoseGraph_Landmark::PoseGraph_Landmark()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::InitDefaults();
  }
  SharedCtor();
  // @@protoc_insertion_point(constructor:cartographer.mapping.proto.PoseGraph.Landmark)
}
PoseGraph_Landmark::PoseGraph_Landmark(const PoseGraph_Landmark& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(NULL),
      _cached_size_(0) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:cartographer.mapping.proto.PoseGraph.Landmark)
}

void PoseGraph_Landmark::SharedCtor() {
  landmark_id_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  global_pose_ = NULL;
  _cached_size_ = 0;
}
...
PoseGraph_Landmark::~PoseGraph_Landmark() {
  // @@protoc_insertion_point(destructor:cartographer.mapping.proto.PoseGraph.Landmark)
  SharedDtor();
}

void PoseGraph_Landmark::SharedDtor() {
...
void PoseGraph_Landmark::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* PoseGraph_Landmark::descriptor() {
  protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const PoseGraph_Landmark& PoseGraph_Landmark::default_instance() {
  protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::InitDefaults();
  return *internal_default_instance();
}

PoseGraph_Landmark* PoseGraph_Landmark::New(::google::protobuf::Arena* arena) const {
  PoseGraph_Landmark* n = new PoseGraph_Landmark;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void PoseGraph_Landmark::Clear() {
// @@protoc_insertion_point(message_clear_start:cartographer.mapping.proto.PoseGraph.Landmark)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
bool PoseGraph_Landmark::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:cartographer.mapping.proto.PoseGraph.Landmark)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "cartographer.mapping.proto.PoseGraph.Landmark.landmark_id"));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:cartographer.mapping.proto.PoseGraph.Landmark)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:cartographer.mapping.proto.PoseGraph.Landmark)
  return false;
#undef DO_
}

void PoseGraph_Landmark::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:cartographer.mapping.proto.PoseGraph.Landmark)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:cartographer.mapping.proto.PoseGraph.Landmark)
}

::google::protobuf::uint8* PoseGraph_Landmark::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:cartographer.mapping.proto.PoseGraph.Landmark)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cartographer.mapping.proto.PoseGraph.Landmark)
  return target;
}

size_t PoseGraph_Landmark::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:cartographer.mapping.proto.PoseGraph.Landmark)
  size_t total_size = 0;
...
void PoseGraph_Landmark::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:cartographer.mapping.proto.PoseGraph.Landmark)
  GOOGLE_DCHECK_NE(&from, this);
  const PoseGraph_Landmark* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const PoseGraph_Landmark>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:cartographer.mapping.proto.PoseGraph.Landmark)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:cartographer.mapping.proto.PoseGraph.Landmark)
    MergeFrom(*source);
  }
}

void PoseGraph_Landmark::MergeFrom(const PoseGraph_Landmark& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.proto.PoseGraph.Landmark)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void PoseGraph_Landmark::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:cartographer.mapping.proto.PoseGraph.Landmark)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void PoseGraph_Landmark::CopyFrom(const PoseGraph_Landmark& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:cartographer.mapping.proto.PoseGraph.Landmark)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool PoseGraph_Landmark::IsInitialized() const {
  return true;
}

void PoseGraph_Landmark::Swap(PoseGraph_Landmark* other) {
  if (other == this) return;
  InternalSwap(other);
}
void PoseGraph_Landmark::InternalSwap(PoseGraph_Landmark* other) {
  using std::swap;
...
::google::protobuf::Metadata PoseGraph_Landmark::GetMetadata() const {
  protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
// string landmark_id = 1;
void PoseGraph_Landmark::clear_landmark_id() {
  landmark_id_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
const ::std::string& PoseGraph_Landmark::landmark_id() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseGraph.Landmark.landmark_id)
  return landmark_id_.GetNoArena();
}
void PoseGraph_Landmark::set_landmark_id(const ::std::string& value) {
  
  landmark_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.PoseGraph.Landmark.landmark_id)
}
#if LANG_CXX11
void PoseGraph_Landmark::set_landmark_id(::std::string&& value) {
  
  landmark_id_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:cartographer.mapping.proto.PoseGraph.Landmark.landmark_id)
}
#endif
void PoseGraph_Landmark::set_landmark_id(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  landmark_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:cartographer.mapping.proto.PoseGraph.Landmark.landmark_id)
}
void PoseGraph_Landmark::set_landmark_id(const char* value, size_t size) {
  
  landmark_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:cartographer.mapping.proto.PoseGraph.Landmark.landmark_id)
}
::std::string* PoseGraph_Landmark::mutable_landmark_id() {
  
  // @@protoc_insertion_point(field_mutable:cartographer.mapping.proto.PoseGraph.Landmark.landmark_id)
  return landmark_id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* PoseGraph_Landmark::release_landmark_id() {
  // @@protoc_insertion_point(field_release:cartographer.mapping.proto.PoseGraph.Landmark.landmark_id)
  
  return landmark_id_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
void PoseGraph_Landmark::set_allocated_landmark_id(::std::string* landmark_id) {
  if (landmark_id != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cartographer.mapping.proto.PoseGraph.Landmark.landmark_id)
}

// .cartographer.transform.proto.Rigid3d global_pose = 2;
bool PoseGraph_Landmark::has_global_pose() const {
  return this != internal_default_instance() && global_pose_ != NULL;
}
void PoseGraph_Landmark::clear_global_pose() {
  if (GetArenaNoVirtual() == NULL && global_pose_ != NULL) delete global_pose_;
  global_pose_ = NULL;
}
const ::cartographer::transform::proto::Rigid3d& PoseGraph_Landmark::global_pose() const {
  const ::cartographer::transform::proto::Rigid3d* p = global_pose_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseGraph.Landmark.global_pose)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::transform::proto::Rigid3d*>(
      &::cartographer::transform::proto::_Rigid3d_default_instance_);
}
::cartographer::transform::proto::Rigid3d* PoseGraph_Landmark::mutable_global_pose() {
  
  if (global_pose_ == NULL) {
    global_pose_ = new ::cartographer::transform::proto::Rigid3d;
  }
  // @@protoc_insertion_point(field_mutable:cartographer.mapping.proto.PoseGraph.Landmark.global_pose)
  return global_pose_;
}
::cartographer::transform::proto::Rigid3d* PoseGraph_Landmark::release_global_pose() {
  // @@protoc_insertion_point(field_release:cartographer.mapping.proto.PoseGraph.Landmark.global_pose)
  
  ::cartographer::transform::proto::Rigid3d* temp = global_pose_;
  global_pose_ = NULL;
  return temp;
}
void PoseGraph_Landmark::set_allocated_global_pose(::cartographer::transform::proto::Rigid3d* global_pose) {
  delete global_pose_;
  ...
  // @@protoc_insertion_point(field_set_allocated:cartographer.mapping.proto.PoseGraph.Landmark.global_pose)
}
...
const int PoseGraph::kLandmarksFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // repeated .cartographer.mapping.proto.PoseGraph.Landmark landmarks = 5;
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
void PoseGraph::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, this->landmarks(static_cast<int>(i)), output);
  }
...
::google::protobuf::uint8* PoseGraph::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        5, this->landmarks(static_cast<int>(i)), deterministic, target);
  }
...
// repeated .cartographer.mapping.proto.PoseGraph.Landmark landmarks = 5;
int PoseGraph::landmarks_size() const {
  return landmarks_.size();
}
void PoseGraph::clear_landmarks() {
  landmarks_.Clear();
}
const ::cartographer::mapping::proto::PoseGraph_Landmark& PoseGraph::landmarks(int index) const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseGraph.landmarks)
  return landmarks_.Get(index);
}
::cartographer::mapping::proto::PoseGraph_Landmark* PoseGraph::mutable_landmarks(int index) {
  // @@protoc_insertion_point(field_mutable:cartographer.mapping.proto.PoseGraph.landmarks)
  return landmarks_.Mutable(index);
}
::cartographer::mapping::proto::PoseGraph_Landmark* PoseGraph::add_landmarks() {
  // @@protoc_insertion_point(field_add:cartographer.mapping.proto.PoseGraph.landmarks)
  return landmarks_.Add();
}
::google::protobuf::RepeatedPtrField< ::cartographer::mapping::proto::PoseGraph_Landmark >*
PoseGraph::mutable_landmarks() {
  // @@protoc_insertion_point(field_mutable_list:cartographer.mapping.proto.PoseGraph.landmarks)
  return &landmarks_;
}
const ::google::protobuf::RepeatedPtrField< ::cartographer::mapping::proto::PoseGraph_Landmark >&
PoseGraph::landmarks() const {
  // @@protoc_insertion_point(field_list:cartographer.mapping.proto.PoseGraph.landmarks)
  return landmarks_;
}
