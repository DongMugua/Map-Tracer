...
void TableStruct::InitDefaultsImpl() {
  ...
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2f2d_2fproto_2fprobability_5fgrid_2eproto::InitDefaults();
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2f3d_2fproto_2fhybrid_5fgrid_2eproto::InitDefaults();
  ...
  _Submap2D_default_instance_._instance.get_mutable()->probability_grid_ = const_cast< ::cartographer::mapping::proto::ProbabilityGrid*>(
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "\033high_resolution_hybrid_grid\030\004 \001(\0132&.car"
      "tographer.mapping.proto.HybridGrid\022J\n\032lo"
      "w_resolution_hybrid_grid\030\005 \001(\0132&.cartogr"
      "apher.mapping.proto.HybridGridb\006proto3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 678);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "cartographer/mapping/proto/submap.proto", &protobuf_RegisterTypes);
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2f2d_2fproto_2fprobability_5fgrid_2eproto::AddDescriptors();
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2f3d_2fproto_2fhybrid_5fgrid_2eproto::AddDescriptors();
...
Submap2D::Submap2D(const Submap2D& from)
  ...
  if (from.has_probability_grid()) {
    probability_grid_ = new ::cartographer::mapping::proto::ProbabilityGrid(*from.probability_grid_);
  } else {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // .cartographer.mapping.proto.ProbabilityGrid probability_grid = 4;
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.proto.Submap2D)
  ...
  if (from.has_probability_grid()) {
    mutable_probability_grid()->::cartographer::mapping::proto::ProbabilityGrid::MergeFrom(from.probability_grid());
  }
...
const ::cartographer::mapping::proto::ProbabilityGrid& Submap2D::probability_grid() const {
  const ::cartographer::mapping::proto::ProbabilityGrid* p = probability_grid_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.Submap2D.probability_grid)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping::proto::ProbabilityGrid*>(
      &::cartographer::mapping::proto::_ProbabilityGrid_default_instance_);
}
::cartographer::mapping::proto::ProbabilityGrid* Submap2D::mutable_probability_grid() {
  
  if (probability_grid_ == NULL) {
    probability_grid_ = new ::cartographer::mapping::proto::ProbabilityGrid;
  }
  // @@protoc_insertion_point(field_mutable:cartographer.mapping.proto.Submap2D.probability_grid)
  return probability_grid_;
}
::cartographer::mapping::proto::ProbabilityGrid* Submap2D::release_probability_grid() {
  // @@protoc_insertion_point(field_release:cartographer.mapping.proto.Submap2D.probability_grid)
  
  ::cartographer::mapping::proto::ProbabilityGrid* temp = probability_grid_;
  probability_grid_ = NULL;
  return temp;
}
void Submap2D::set_allocated_probability_grid(::cartographer::mapping::proto::ProbabilityGrid* probability_grid) {
  delete probability_grid_;
