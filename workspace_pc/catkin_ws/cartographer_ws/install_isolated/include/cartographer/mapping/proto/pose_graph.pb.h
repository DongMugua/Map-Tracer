...
class PoseGraph_Landmark;
class PoseGraph_LandmarkDefaultTypeInternal;
extern PoseGraph_LandmarkDefaultTypeInternal _PoseGraph_Landmark_default_instance_;
class SubmapId;
...
class PoseGraph_Landmark : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraph.Landmark) */ {
 public:
  PoseGraph_Landmark();
  virtual ~PoseGraph_Landmark();

  PoseGraph_Landmark(const PoseGraph_Landmark& from);

  inline PoseGraph_Landmark& operator=(const PoseGraph_Landmark& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  PoseGraph_Landmark(PoseGraph_Landmark&& from) noexcept
    : PoseGraph_Landmark() {
    *this = ::std::move(from);
  }

  inline PoseGraph_Landmark& operator=(PoseGraph_Landmark&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const PoseGraph_Landmark& default_instance();

  static inline const PoseGraph_Landmark* internal_default_instance() {
    return reinterpret_cast<const PoseGraph_Landmark*>(
               &_PoseGraph_Landmark_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    3;

  void Swap(PoseGraph_Landmark* other);
  friend void swap(PoseGraph_Landmark& a, PoseGraph_Landmark& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline PoseGraph_Landmark* New() const PROTOBUF_FINAL { return New(NULL); }

  PoseGraph_Landmark* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const PoseGraph_Landmark& from);
  void MergeFrom(const PoseGraph_Landmark& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(PoseGraph_Landmark* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:cartographer.mapping.proto.PoseGraph.Landmark)
 private:
...
class PoseGraph : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraph) */ {
 public:
  ...
  typedef PoseGraph_Landmark Landmark;
  ...
  static const int kLandmarksFieldNumber = 5;
  const ::cartographer::mapping::proto::PoseGraph_Landmark& landmarks(int index) const;
  ::cartographer::mapping::proto::PoseGraph_Landmark* mutable_landmarks(int index);
  ::cartographer::mapping::proto::PoseGraph_Landmark* add_landmarks();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::cartographer::mapping::proto::PoseGraph_Landmark > landmarks_;
  mutable int _cached_size_;
  friend struct protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2eproto::TableStruct;
};
// ===================================================================
...
#if LANG_CXX11
inline void PoseGraph_Landmark::set_landmark_id(::std::string&& value) {
...
#endif
inline void PoseGraph_Landmark::set_landmark_id(const char* value) {
...
inline void PoseGraph_Landmark::set_landmark_id(const char* value, size_t size) {
...
inline ::std::string* PoseGraph_Landmark::mutable_landmark_id() {
...
inline ::std::string* PoseGraph_Landmark::release_landmark_id() {
...
inline void PoseGraph_Landmark::set_allocated_landmark_id(::std::string* landmark_id) {
  if (landmark_id != NULL) {
...
// .cartographer.transform.proto.Rigid3d global_pose = 2;
inline bool PoseGraph_Landmark::has_global_pose() const {
  return this != internal_default_instance() && global_pose_ != NULL;
}
inline void PoseGraph_Landmark::clear_global_pose() {
  if (GetArenaNoVirtual() == NULL && global_pose_ != NULL) delete global_pose_;
  global_pose_ = NULL;
}
inline const ::cartographer::transform::proto::Rigid3d& PoseGraph_Landmark::global_pose() const {
...
inline ::cartographer::transform::proto::Rigid3d* PoseGraph_Landmark::mutable_global_pose() {
...
inline ::cartographer::transform::proto::Rigid3d* PoseGraph_Landmark::release_global_pose() {
...
inline void PoseGraph_Landmark::set_allocated_global_pose(::cartographer::transform::proto::Rigid3d* global_pose) {
  delete global_pose_;
...
// repeated .cartographer.mapping.proto.PoseGraph.Landmark landmarks = 5;
inline int PoseGraph::landmarks_size() const {
  return landmarks_.size();
}
inline void PoseGraph::clear_landmarks() {
  landmarks_.Clear();
}
inline const ::cartographer::mapping::proto::PoseGraph_Landmark& PoseGraph::landmarks(int index) const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseGraph.landmarks)
  return landmarks_.Get(index);
}
inline ::cartographer::mapping::proto::PoseGraph_Landmark* PoseGraph::mutable_landmarks(int index) {
  // @@protoc_insertion_point(field_mutable:cartographer.mapping.proto.PoseGraph.landmarks)
  return landmarks_.Mutable(index);
}
inline ::cartographer::mapping::proto::PoseGraph_Landmark* PoseGraph::add_landmarks() {
  // @@protoc_insertion_point(field_add:cartographer.mapping.proto.PoseGraph.landmarks)
  return landmarks_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::cartographer::mapping::proto::PoseGraph_Landmark >*
PoseGraph::mutable_landmarks() {
  // @@protoc_insertion_point(field_mutable_list:cartographer.mapping.proto.PoseGraph.landmarks)
  return &landmarks_;
}
inline const ::google::protobuf::RepeatedPtrField< ::cartographer::mapping::proto::PoseGraph_Landmark >&
